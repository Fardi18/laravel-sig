    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Edit Spot</h5>

                        <!-- General Form Elements -->
                        <form action="/admin/spot/{{ $spot->id }}" method="POST" enctype="multipart/form-data">
                            @method('put')
                            @csrf
                            <div class="row mb-3">
                                <label for="name" class="col-sm-2 col-form-label">Nama Spot</label>
                                <div class="col-sm-10">
                            ...
                            <div class="row mb-3">
                                <label for="description" class="col-sm-2 col-form-label">Deskripsi Spot</label>
                                <div class="col-sm-10">
                                    <textarea class="form-control description @error('description') is-invalid @enderror" style="height: 100px"
                                        name="description" id="description">{!! $spot->description !!}</textarea>
                                </div>
                                @error('description')
                                    <div class="invalid-feedback">
                            ...
                            <div class="row mb-3">
                                <label for="image" class="col-sm-2 col-form-label">Gambar Spot</label>
                                <div class="col-sm-10">
                            ...
                            <div class="row mb-3">
                                <label for="address" class="col-sm-2 col-form-label">Alamat Spot</label>
                                <div class="col-sm-10">
                                    <textarea type="text" class="form-control @error('address') is-invalid @enderror" name="address">{{ $spot->address }}</textarea>
                                </div>
                                @error('address')
                                    <div class="invalid-feedback">
                            ...
                            <div class="row mb-3">
                                <label for="location" class="col-sm-2 col-form-label">Lokasi Spot (Latitude,
                                    Longitude)</label>
                                <div class="col-sm-10">
                                    <div class="input-group">
                                        <input type="text" class="form-control @error('location') is-invalid @enderror"
                                            name="location" id="location" placeholder="Masukkan data lokasi"
